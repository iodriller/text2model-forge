...
class StudioQwen:
    def __init__(
        ...
        *,
        ...
        # it from many small calls instead; see src/text2model_forge/chunked_spec.py for
    ...
    def _compile_spec_monolithic(self, description: str) -> StudioAssetSpec:
        prompt = f"""
You are Qwen in ASSET ARCHITECT mode for Text2Model Forge Text2Model. Convert the user's single description into one original,
...
grey studio backdrop fails -- see make_chroma_alpha in src/text2model_forge/studio_comfy.py. Apply the structured asset kind, behavior, components, dimensions,
            ...
            messages=[
                {
                    "role": "user",
                    "content": (
                        "You mediate a rejected Text2Model gate. Diagnose the rejection using the complete ordered "
