...
def build_sdxl_workflow(
    ...
    prefix = f"Text2Model/{project['project_id']}/{asset_id}/{mode}"
    workflow = {
...
class ComfyClient:
    ...
    def upload_image(self, name: str, data: bytes, subfolder: str = "text2model-forge/sprites") -> str:
        boundary = "----Text2Model" + uuid.uuid4().hex
        parts = []
