"""Fail-closed delivery packaging for validated Darkness artifacts."""
...
def build_delivery_package(
    *,
    ...
    (output / "darkness-package.json").write_text(manifest.model_dump_json(indent=2), encoding="utf-8")
    return manifest
