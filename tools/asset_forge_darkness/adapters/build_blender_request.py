...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--operation-id", choices=("blender.analyze", "blender.repair", "blender.repair_retopology", "blender.propose_short_biped_rig", "blender.export"), default="blender.analyze")
