...
def main():
    ...
    import os
    debug_colors = os.environ.get("TEXT2MODEL_FORGE_DEBUG_FACE") == "1"
    if debug_colors:
    ...
    armature["text2model_forge_asset_id"] = "goblin"
    armature["text2model_forge_source_kind"] = "owned_blender_master"
    armature["text2model_forge_generator"] = "warrior_adapter_goblin_v1"
    armature["text2model_forge_base_license"] = "CC0-1.0 Quaternius RPG Characters"
