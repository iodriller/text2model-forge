...
def add_landmarks(landmarks):
    ...
    for name, point in landmarks.items():
        ...
        marker["text2model_forge_landmark"] = name
...
def main():
    ...
    target["text2model_forge_stage"] = "anatomy_target"
    target["text2model_forge_production_eligible"] = False
    target["text2model_forge_family_template"] = spec["family_template"]
    ...
    print("TEXT2MODEL_FORGE_GENESIS_TARGET=" + output_path)
    print("TEXT2MODEL_FORGE_GENESIS_REPORT=" + report_path)
