...
def main():
    ...
    armature["text2model_forge_asset_id"] = profile.get("species", profile["id"])
    armature["text2model_forge_source_kind"] = "owned_blender_master"
    armature["text2model_forge_generator"] = "creature_dna_biped_v1"
    armature["text2model_forge_morphology_profile"] = profile["id"]
    armature["text2model_forge_morphology_sha256"] = sha256_file(profile_path)
    armature["text2model_forge_family"] = profile["family"]
    ...
    print("TEXT2MODEL_FORGE_CREATURE=" + output)
    print("TEXT2MODEL_FORGE_MORPHOLOGY_REPORT=" + report_path)
