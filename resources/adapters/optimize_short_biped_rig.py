...
from text2model_forge.canonical_optimizer import (  # noqa: E402
...
from text2model_forge.config import load_local_config, worker_binding  # noqa: E402
from text2model_forge.external_worker import SubprocessWorkerAdapter  # noqa: E402
from text2model_forge.hashing import sha256_file  # noqa: E402
from text2model_forge.manifests import load_manifests  # noqa: E402
from text2model_forge.optimizer import LocalDeployOptimizer  # noqa: E402
from text2model_forge.schemas import (  # noqa: E402
    ArtifactLineage,
    ArtifactRecord,
    AssetStage,
    EvidenceBundle,
...
from text2model_forge.workers import WorkerManager  # noqa: E402
...
def _write_human_review(
    ...
    *,
    ...
    review = "\n".join(
        [
            "# Text2Model rig optimizer interim review",
            "",
            f"- Source: `{source}`",
            ...
            *remaining,
            ...
            "## Human decision",
            "",
            "Do you approve the best accepted checkpoint as the canonical-rig direction, or should Text2Model "
...
def run_episode(args: argparse.Namespace) -> dict[str, object]:
    ...
    if output_root != workspace and workspace not in output_root.parents:
        raise ValueError("optimization output directory must be inside the Text2Model workspace")
    binding = worker_binding(config, "blender")
    if binding is None:
        raise RuntimeError("Blender has no configured Text2Model worker binding")
