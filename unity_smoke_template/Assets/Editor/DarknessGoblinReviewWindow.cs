...
{
    /// <summary>
    /// Small, non-promoting human-review surface for a portable Darkness candidate.
    ...
    public sealed class DarknessGoblinReviewWindow : EditorWindow
    {
        ...
        private void LoadCandidate()
        {
            try
            {
                _packagePath = Environment.GetEnvironmentVariable("DARKNESS_CANDIDATE_PACKAGE");
    ...
    internal static class DarknessGoblinReviewStartup
    {
        ...
        {
            var package = Environment.GetEnvironmentVariable("DARKNESS_CANDIDATE_PACKAGE");
