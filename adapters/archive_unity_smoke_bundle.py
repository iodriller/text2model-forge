"""Create a deterministic transfer ZIP for a verified Darkness Unity smoke bundle."""
...
def archive(bundle: Path, output: Path) -> dict[str, object]:
    ...
    if manifest.get("bundle_kind") != "darkness_standalone_unity_smoke":
        raise ValueError("not a Darkness standalone Unity smoke bundle")
