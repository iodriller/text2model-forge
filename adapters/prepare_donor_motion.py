...
Why this is needed
------------------
`adapters/retarget_humanoid_motion.py` retargets against a fixed `BONE_CHAINS`
...
Handedness
----------
The retarget contract deliberately maps Quaternius *right* to the Darkness
...
Usage
-----
    blender --background --factory-startup --python adapters/prepare_donor_motion.py \
